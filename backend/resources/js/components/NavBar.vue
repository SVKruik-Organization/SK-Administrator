...
import { index as preferencesIndex } from '@/routes/user/preferences';
...
<template>
    <nav
        class="flex items-center justify-between box-border p-4 gap-4 border-sky-100 fixed bottom-0 w-full md:static md:border-b">
        <!-- Mobile hamburger button -->
        <button
            class="flex items-center justify-center gap-2 cursor-pointer bg-sky-50 hover:bg-sky-100 rounded-full h-10 w-10 md:hidden"
        ...
        <section class="flex items-center gap-2">
            <div ref="notificationDropdownRef" class="relative hidden md:block">
                ...
                <button
                    class="hidden items-center justify-center gap-2 cursor-pointer bg-sky-50 hover:bg-sky-100 rounded-full h-10 w-10 md:flex"
            ...
            <div ref="quickMenuDropdownRef" class="relative">
                <!-- Quick menu button -->
                <button
                    class="flex items-center justify-center gap-2 cursor-pointer bg-sky-50 hover:bg-sky-100 rounded-full h-10 w-10"
